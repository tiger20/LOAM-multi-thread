...
namespace loam
{
  ...
  public:
    ...
    */
    ...
    void processScanlines(std::vector<pcl::PointCloud<pcl::PointXYZI>> const& laserCloudScans);
    ...
    */
    ...
    pcl::PointCloud<pcl::PointXYZ>& imuTransform() { return _imuTrans; }
    Time& sweepStart() { return _sweepStart; }
    pcl::PointCloud<pcl::PointXYZI>& laserCloud() { return _laserCloud; }
    pcl::PointCloud<pcl::PointXYZI>& cornerPointsSharp() { return _cornerPointsSharp; }
    pcl::PointCloud<pcl::PointXYZI>& cornerPointsLessSharp() { return _cornerPointsLessSharp; }
    pcl::PointCloud<pcl::PointXYZI>& surfacePointsFlat() { return _surfacePointsFlat; }
    pcl::PointCloud<pcl::PointXYZI>& surfacePointsLessFlat() { return _surfacePointsLessFlat; }
    RegistrationParams& config() { return _config; }
